...
| 页面 | 在线打开 | 仓库文件 |
|---|---|---|
| **TUI 设计 demo**<br><sub>两种风格上下排列，各占一屏，可直接对照（两者都是 TUI，差别在版式）</sub> | [tui-demo.html ↗](https://cinnnnnnndy.github.io/DevKit/kunpeng-devkit-ai-tui/web/tui-demo.html) | [`web/tui-demo.html`](kunpeng-devkit-ai-tui/web/tui-demo.html) |
| ├ **风格 A · 单栏工作台**<br><sub>十幕交互演示，可自动播放或键盘切换，右侧标注每幕的设计 Pattern 与"哇点"</sub> | [demo.html ↗](https://cinnnnnnndy.github.io/DevKit/kunpeng-devkit-ai-tui/web/demo.html) | [`web/demo.html`](kunpeng-devkit-ai-tui/web/demo.html) |
| └ **风格 B · 三栏分屏工作台**<br><sub>典型一屏：资源管理器 │ 源码预览 │ Agent 三个面板，Agent 面板承载主标签内容</sub> | [demo-studio.html ↗](https://cinnnnnnndy.github.io/DevKit/kunpeng-devkit-ai-tui/web/demo-studio.html) | [`web/demo-studio.html`](kunpeng-devkit-ai-tui/web/demo-studio.html) |
